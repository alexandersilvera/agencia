...
import logo_reino_da_mata from 'assets/img/centroumbandistareinodamata_0.png'
...
const navigation = {
    ...
    social: [
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/reinodamata',
        icon: (props) => (
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/reinodamata/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
      ...
      {
        name: 'Twitter',
        href: 'https://twitter.com/alexsilvera1/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/alexandersilvera/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
    ...
    return(
        ...
        <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-700 xl:text-center">&copy; 2020 Reino da Mata, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
