...
function Servicies(){
  ...
  return(
      <Layout>
          <Helmet>
            <title>Centro Reino da Mata | Servicios</title>
          ...
          <div className="pt-28 ">
            ...
            <ServicesList posts={posts_software} section_title={'Servicio de Software y Productos de Desarrollo'}/>  
            <ServicesList posts={posts_desingn} section_title={'Desing Services'}/>  
